        ...
        {/*--------------- Footer-Logo on Left Side--------- */}
            ...
            {/* Location Box */}
                    <button onClick={() => setOpen(!open)} className="w-full flex items-center justify-between px-4 py-2
                        border border-gray-900 rounded-md text-black bg-transparent hover:border-gray-400 font-['rooneySansRegular']"
                        aria-expanded={open}>
            ...
            {/* Dropdown */}
                    ...
                    className="px-4 py-2 cursor-pointer font-['rooneySansRegular'] text-black hover:bg-gray-300">{city}</div>
                    ))}
                    </div>
                    )}
